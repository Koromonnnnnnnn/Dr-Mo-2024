...
pygame.draw.arc(screen, green, (200, 150, 400, 400), 3 * math.pi / 2, 2 * math.pi, 12)
...
pygame.draw.arc(
    screen, green, (180, 130, 440, 440), 9 * math.pi / 4, 3 * math.pi / 4, 12
)
pygame.draw.arc(
    screen, cyan, (180, 130, 440, 440), 3 * math.pi / 4, 5 * math.pi / 4, 12
)
pygame.draw.arc(
    screen, blue, (180, 130, 440, 440), 5 * math.pi / 4, 7 * math.pi / 4, 12
)
...
pygame.draw.arc(screen, green, (160, 110, 480, 480), math.pi / 2, 2 * math.pi / 3, 12)
pygame.draw.arc(
    screen, chartreuse, (160, 110, 480, 480), 2 * math.pi / 3, 5 * math.pi / 6, 12
)
...
pygame.draw.arc(
    screen, purple, (160, 110, 480, 480), 7 * math.pi / 6, 4 * math.pi / 3, 12
)
...
pygame.draw.arc(
    screen, rose, (160, 110, 480, 480), 3 * math.pi / 2, 5 * math.pi / 3, 12
)
pygame.draw.arc(
    screen, maroon, (160, 110, 480, 480), 5 * math.pi / 3, 11 * math.pi / 6, 12
)
